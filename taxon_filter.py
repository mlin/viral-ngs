...
def deplete_bmtagger(inBam, refDbs):
    ...
    markDuplicatesPath = tools.picard.MarkDuplicatesTool() \
        .install_and_get_path()
    ...
    # Temporary...
    mvicunaPath = \
        '/gsap/garage-viral/viral/analysis/xyang/programs/M-Vicuna/bin/mvicuna'
...
def main_deplete_bmtagger(args):
    ...
    return 0
__commands__.append(('deplete_bmtagger', main_deplete_bmtagger,
                    parser_deplete_bmtagger))
